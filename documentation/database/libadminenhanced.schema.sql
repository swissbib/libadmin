...
--
-- Current Database: `libadminenhanced`
--

/*!40000 DROP DATABASE IF EXISTS `libadminenhanced`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `libadminenhanced` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `institution` (
  ...
  `korrespondezsprache` varchar(10) DEFAULT NULL,
  `bfscode` varchar(50) DEFAULT NULL,
  `worldcat_ja_nein` tinyint(1) DEFAULT NULL,
  `worldcat_symbol` varchar(30) DEFAULT NULL,
  `cbslibrarycode` varchar(50) DEFAULT NULL,
  `verrechnungbeitrag` varchar(50) DEFAULT NULL,
  `zusage_beitrag` tinyint(1) DEFAULT NULL,
  `id_kostenbeitrag` int(11) DEFAULT NULL,
