 ...
 *
 * This exports what is need by the search engine
 *
 */
class SearchIndex extends System
{
    /**
    ...
    public function getJsonData()
    {
        try {
            $data = [
                'institutions' => $this->getJsonPayloadData()
            ];
        } catch (\Exception $e) {
            $data = [
                'success' => false,
    ...
    protected function getJsonPayloadData()
    {
        ...
        foreach ($groups as $group) {
            ...
            foreach ($institutions as $institution) {
                try {
                    $data[] = $this->extractInstitutionData($institution, $group);
                } catch(\Exception $e) {
     ...
     * @param Group       $group       the group (network)
     *
     * @return array
     */
